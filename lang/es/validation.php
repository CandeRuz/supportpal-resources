...
return array(
	...
	*/
    ...
    "size"                      => array(
        ...
        "array"   => "El campo de :attribute debe contener :size items.",
    ),
    ...
    "gt"                        => array(
        ...
        "array"   => "El campo de :attribute debe tener más de :value items.",
    ),
    "gte"                       => array(
        ...
        "array"   => "El campo de :attribute debe tener :value items o más.",
    ),
    "in_array"                  => "El campo de :attribute no existe en :other.",
    ...
    "lt"                        => array(
        ...
        "array"   => "El campo de :attribute debe tener menos de :value items.",
    ),
    "lte"                       => array(
        ...
        "array"   => "El campo de :attribute no debe tener más de :value items.",
    ),
