...
return array(
    ...
    "department_desc"           => "Los departamentos son exactamente iguales que los de tu organización. Useful for ensuring customer enquiries get to the correct staff member(s) quickly.",
    "department_email"          => "Direcciones de correo electrónico de departamento",
    "dept_email_desc"           => "Múltiples direciones de correo se pueden asignar a un departamento determinado. Email collection is performed against the configured addresses to pull emails from your customers into the help desk.",
    ...
    "schedule_task_2"           => "Las tareas programadas necesitan una tarea del cronograma para ser creadas para funcionar. El intervalo para cada tarea llevada a cabo por el cron job se puede ajustar a través de the edit form.",
    ...
    "ticket_channel_2"          => "Nosotros ofrecemos una serie de canales por defecto. You may wish to activate and configure the Facebook and Twitter channels to collect tickets generated via social media.",
