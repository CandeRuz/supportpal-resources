...
return array(
    ...
    "dept_email_desc"           => "Múltiples direcciones de correo se pueden asignar a un departamento determinado. Email collection is performed against the configured addresses to pull emails from your customers into the help desk.",
